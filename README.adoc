...
=== Vert.x Tracing examples

link:tracing-examples/README.adoc[Vert.x tracing examples] contains a wide range of examples using Vert.x Opentracing and Vert.x Zipkin.
